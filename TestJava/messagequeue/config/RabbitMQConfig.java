...
public class RabbitMQConfig {
    ...
    // private static final String CATALOG_ROUTING_KEY = "*.catalog.*";
    ...
    @Bean
    public RabbitTemplate mqTemplate(Jackson2JsonMessageConverter object2JSON) {
        RabbitTemplate baseTemplate = new RabbitTemplate(cachingConnectionFactory);
        baseTemplate.setMessageConverter(object2JSON);
        return baseTemplate;
    }
